...
function AppContent() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-black text-zinc-100 outline-none">
        ...
        <header className="flex-shrink-0 z-30 bg-zinc-950/95 backdrop-blur-lg border-b border-zinc-800/50 hidden md:block outline-none">
          <div className="flex items-center gap-3 px-4 py-3">
            <button
              ...
              className="p-2 rounded-lg bg-transparent border border-zinc-700 text-zinc-400 hover:bg-zinc-800 hover:text-sky-400 active:bg-zinc-800 flex-shrink-0 outline-none select-none ring-0 focus:ring-0"
