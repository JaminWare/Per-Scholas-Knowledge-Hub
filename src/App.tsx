...
function AppContent() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-200 dark:bg-[#1e2530] text-zinc-800 dark:text-slate-200 cursor-none">
      ...
      {/* ── Sidebar ─────────────────────────────────── */}
      <div
        className={`flex-shrink-0 border-r border-slate-600 h-full overflow-hidden transition-all duration-300 ease-in-out ${
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden min-w-0">
        ...
        <header className="flex-shrink-0 z-30 bg-zinc-800/95 dark:bg-[#1e2530]/90 backdrop-blur-lg border-b border-zinc-200 dark:border-slate-700">
