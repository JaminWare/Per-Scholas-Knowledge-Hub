...
export default function Sidebar({ onToggle }: SidebarProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-zinc-50 dark:bg-zinc-800 border-r border-zinc-300 dark:border-zinc-700">
      {/* Header */}
        ...
        {tracks.map((track) => (
          <div key={track.id} className="pt-3">
            <button
              ...
              className={`w-full flex items-center gap-2 px-2 py-2 rounded-lg border ${trackBorder[track.color]} hover:bg-zinc-200 dark:hover:bg-zinc-700/50 transition-colors mb-1`}
            >
