...
export default function Sidebar({ onToggle }: SidebarProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-zinc-200 dark:bg-zinc-800 border-r border-zinc-300 dark:border-zinc-700">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-300 dark:border-zinc-700 flex-shrink-0">
        ...
        <button
          onClick={onToggle}
          className="p-1.5 rounded-lg text-zinc-500 dark:text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-200 hover:bg-zinc-300 dark:hover:bg-zinc-700 transition-colors flex-shrink-0"
        ...
        {tracks.map((track) => (
          <div key={track.id} className="pt-3">
            <button
              ...
              className={`w-full flex items-center gap-2 px-2 py-2 rounded-lg border ${trackBorder[track.color]} hover:bg-zinc-300 dark:hover:bg-zinc-700/50 transition-colors mb-1`}
            >
