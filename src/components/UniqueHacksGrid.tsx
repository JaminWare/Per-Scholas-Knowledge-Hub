...
export default function UniqueHacksGrid() {
  ...
  return (
    <section className="mt-8">
      <div className="bg-zinc-100 dark:bg-zinc-700 border border-zinc-300 dark:border-zinc-600 rounded-xl p-5">
        {/* Header */}
          ...
          {tiles.map((tile) => {
            ...
            return (
              <button
                ...
                className={`group flex items-start gap-4 p-4 text-left bg-zinc-200 dark:bg-zinc-600/50 border border-zinc-300 dark:border-zinc-600 rounded-xl transition-all ${tile.accentClass}`}
              >
