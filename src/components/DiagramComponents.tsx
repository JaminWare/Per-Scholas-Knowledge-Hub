  ...
  return (
    <div className={`w-full overflow-x-auto ${className ?? ''}`}>
      ...
      <svg viewBox="0 0 800 220" className="w-full h-auto" preserveAspectRatio="xMidYMid meet">
        ...
        <text x="90" y="95" fontSize="18" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          🌐
        </text>
        <text x="90" y="125" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          INTERNET / WAN
        </text>
        ...
        <text x="185" y="100" fontSize="11" style={{ fill: 'currentColor' }} className="text-red-400" textAnchor="middle" fontWeight="bold">
          Untrusted
        </text>

        {/* Center: Firewall */}
        <rect x="210" y="20" width="160" height="180" rx="8" fill="rgba(180, 83, 9, 0.15)" stroke="rgba(217, 119, 6, 0.7)" strokeWidth="2" />
        <text x="290" y="70" fontSize="22" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          🔥
        </text>
        <text x="290" y="105" fontSize="14" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          FIREWALL
        </text>
        <text x="290" y="135" fontSize="10" style={{ fill: 'currentColor' }} className="text-zinc-400" textAnchor="middle">
          ACL Rules
        </text>
        <text x="290" y="155" fontSize="10" style={{ fill: 'currentColor' }} className="text-zinc-400" textAnchor="middle">
          SPI Engine
        </text>
        ...
        <text x="395" y="160" fontSize="11" style={{ fill: 'currentColor' }} className="text-teal-400" textAnchor="middle" fontWeight="bold">
          Isolated
        </text>
        ...
        <text x="500" y="50" fontSize="16" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          💻
        </text>
        <text x="500" y="73" fontSize="11" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          PRIVATE LAN
        </text>

        {/* Right: DMZ (bottom) */}
        <rect x="420" y="120" width="160" height="80" rx="8" fill="rgba(20, 184, 166, 0.1)" stroke="rgba(20, 184, 166, 0.6)" strokeWidth="2" />
        <text x="500" y="150" fontSize="16" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          🌐
        </text>
        <text x="500" y="173" fontSize="11" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          DMZ
        </text>

        {/* Labels inside right boxes */}
        <text x="500" y="62" fontSize="9" style={{ fill: 'currentColor' }} className="text-zinc-400" textAnchor="middle">
          Endpoints · Servers
        </text>
        <text x="500" y="162" fontSize="9" style={{ fill: 'currentColor' }} className="text-zinc-400" textAnchor="middle">
          Public Servers
        </text>
      </svg>
    </div>
  ...
  return (
    <div className={`w-full overflow-x-auto ${className ?? ''}`}>
      ...
      <svg viewBox="0 0 900 140" className="w-full h-auto" preserveAspectRatio="xMidYMid meet">
        ...
        <text x="90" y="75" fontSize="13" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          Header Parse
        </text>
        ...
        <text x="270" y="75" fontSize="13" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          State Table Lookup
        </text>
        ...
        <text x="450" y="75" fontSize="13" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          ACL Rules Check
        </text>
        ...
        <text x="620" y="40" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          ALLOW ✓
        </text>

        {/* Node 4b: DROP */}
        <rect x="560" y="80" width="120" height="50" rx="15" fill="rgba(239, 68, 68, 0.15)" stroke="rgba(248, 113, 113, 0.6)" strokeWidth="2" />
        <text x="620" y="110" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          DROP ✗
        </text>
      </svg>
    </div>
    ...
    <div className={`w-full overflow-x-auto ${className ?? ''}`}>
      ...
      <div className={`flex flex-col-reverse gap-3 ${className ?? ''}`}>
        ...
        <div className="bg-teal-900/30 border border-teal-700 rounded-lg p-4">
          <div className="flex justify-between items-center">
            <span className="text-xs font-bold uppercase text-teal-300">PaaS</span>
        ...
        <div className="bg-violet-900/30 border border-violet-700 rounded-lg p-4">
          <div className="flex justify-between items-center">
            <span className="text-xs font-bold uppercase text-violet-300">SaaS</span>
  ...
  return (
    <div className={`w-full overflow-x-auto ${className ?? ''}`}>
      ...
      <svg viewBox="0 0 1000 140" className="w-full h-auto" preserveAspectRatio="xMidYMid meet">
        ...
        <text x="80" y="75" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          Raw Prompt
        </text>
        ...
        <text x="240" y="70" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          🛡
        </text>
        <text x="240" y="88" fontSize="11" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          PHI Scrubbing
        </text>
        ...
        <text x="410" y="75" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          LLM Context
        </text>
        ...
        <text x="580" y="75" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          Clinical Verify
        </text>
        ...
        <text x="750" y="75" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          Output ✓
        </text>
      </svg>
    </div>
        ...
        {layers.map((layer, idx) => (
          <div
            ...
            className={`flex items-center gap-3 p-3 rounded ${
              idx % 2 === 0 ? 'bg-zinc-800/50' : 'bg-zinc-900/40'
            }`}
          >
            {/* Layer Number Badge */}
            ...
            {/* Layer Name */}
            <span className="text-sm font-semibold text-zinc-300 w-32 flex-shrink-0">
              {layer.name}
            </span>

            {/* PDU Chip */}
            <div className={`px-2.5 py-0.5 rounded-full text-[11px] font-bold font-mono border ${borderColorMap[layer.color]} text-zinc-300 bg-zinc-800/50`}>
              {layer.pdu}
            </div>
          </div>
        ))}
  ...
  return (
    <div className={`w-full overflow-x-auto ${className ?? ''}`}>
      ...
      <svg viewBox="0 0 800 180" className="w-full h-auto" preserveAspectRatio="xMidYMid meet">
        ...
        <text x="230" y="80" fontSize="10" style={{ fill: 'currentColor' }} className="text-emerald-400" textAnchor="middle" fontWeight="bold">
          Raw HL7 →
        </text>
        ...
        <text x="470" y="80" fontSize="10" style={{ fill: 'currentColor' }} className="text-teal-400" textAnchor="middle" fontWeight="bold">
          FHIR →
        </text>
  ...
  return (
    <div className={`w-full overflow-x-auto ${className ?? ''}`}>
      ...
      <svg viewBox="0 0 950 140" className="w-full h-auto" preserveAspectRatio="xMidYMid meet">
        ...
        <text x="85" y="75" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          Device Powers On
        </text>
        ...
        <text x="245" y="75" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          MDM Discovery
        </text>
        ...
        <text x="405" y="75" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          Profile Push
        </text>
        ...
        <text x="565" y="75" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          Compliance Check
        </text>
        ...
        <text x="725" y="75" fontSize="12" fontWeight="bold" style={{ fill: 'currentColor' }} className="text-zinc-300" textAnchor="middle">
          Enrolled ✓
        </text>
      </svg>
    </div>
