        ...
        <div className="flex-shrink-0">
          {contributor.avatar_url ? (
            <img
              ...
              className="w-16 h-16 rounded-xl object-cover ring-2 ring-sky-500/20"
            />
          ) : (
            <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-sky-500 to-sky-400 flex items-center justify-center shadow-lg shadow-sky-500/20">
