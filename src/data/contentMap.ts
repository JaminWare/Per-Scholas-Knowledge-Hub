...
shutdown /r /o           :: Restart to Advanced Boot Options`,
      ...
      {
        type: 'warning',
        text: 'CRITICAL EXAM RULE: Always run DISM /RestoreHealth BEFORE sfc /scannow. SFC relies on the component store to repair filesif the store is corrupted, SFC will silently use bad data. This ordering question appears on virtually every Core 2 exam.',
      },
      { type: 'heading', text: '3. Windows Disk & Partition Management' },
      {
        ...
        rows: [
          ...
          ['defrag', 'Defragment HDD', 'defrag C: /O (optimizeSSD trim or HDD defrag)'],
...
# Cerner FHIRSearch observations by patient + code
...
Content-Type: application/fhir+json
{
  ...
  // ─────────────────────────────────────────────────────────
  // STUDY TIPSOverview pages (re-routed to Core 1)
  // ─────────────────────────────────────────────────────────
  ...
  'study-tips/core1-overview': {
    ...
    content: [
      ...
      { type: 'tip', text: 'Domain 5.0 is the highest weighted domain at 29%. Prioritize motherboard troubleshooting PBQs and the 8 step diagnostic methodology. Domain 3.0 Hardware at 25% is secondfocus on DDR generations, PCIe lanes, and form factors.' },
      ...
      { type: 'steps', items: [
        ...
        'Domain 2.0: Memorize port numbers cold20/21 FTP, 22 SSH, 53 DNS, 80/443 HTTP/HTTPS, 3389 RDP.',
      ...
      { type: 'warning', text: 'The 220-1201 exam contains PBQ (Performance Based Questions) that are drag and drop simulations, not multiple choice. You cannot skip themthey are scored at the beginning of the exam. Practice PBQs weekly.' },
    ],
  },
...
and explain why each answer is correct or incorrect.` },
  ...
  'study-tips/acronyms': {
    ...
    content: [
      {
        type: 'intro',
        text: 'This master acronym directory covers every abbreviation tested on CompTIA A+ (Core 1 & Core 2) plus Healthcare IT certifications. Organized by domain with definitions and context. Bookmark this pageacronym questions appear in every section of both exams.',
      },
      { type: 'heading', text: '1. Networking & Protocols (Core 1 Domain 2.0)' },
      {
        ...
        rows: [
          ...
          ['UDP', 'User Datagram Protocol', 'Connectionless, best effort deliveryused for DNS, VoIP, streaming'],
      ...
      { type: 'heading', text: '2. Security & Encryption (Core 2 Domain 2.0)' },
      {
        ...
        rows: [
          ...
          ['SSL', 'Secure Sockets Layer', 'DEPRECATED predecessor to TLSnever use SSL 2.0/3.0'],
          ['AES', 'Advanced Encryption Standard', 'Symmetric encryption128/192/256 bit. Gold standard for data at rest.'],
          ['RSA', 'Rivest Shamir Adleman', 'Asymmetric encryptionpublic/private key pair for key exchange'],
          ...
          ['TPM', 'Trusted Platform Module', 'Hardware security chip for encryption keysrequired for Win 11'],
      ...
      { type: 'heading', text: '3. Hardware & Storage (Core 1 Domain 3.0)' },
      {
        ...
        headers: ['Acronym', 'Full Term', 'Definition / Context'],
        rows: [
          ['RAM', 'Random Access Memory', 'Volatile working memoryDDR4/DDR5 in modern systems'],
          ...
          ['SATA', 'Serial Advanced Technology Attachment', 'Storage interface6 Gb/s max (SATA III)'],
          ['PCIe', 'Peripheral Component Interconnect Express', 'High speed serial expansion bus for GPU, NVMe, NICs'],
          ['BIOS', 'Basic Input/Output System', 'Legacy firmware interfacebeing replaced by UEFI'],
          ...
          ['GPU', 'Graphics Processing Unit', 'Dedicated video processingPCIe x16 slot'],
          ['PSU', 'Power Supply Unit', 'Converts AC to DCprovides 3.3V, 5V, 12V rails'],
      ...
      { type: 'heading', text: '5. Operating Systems & Virtualization (Core 1 Domain 4.0)' },
      {
        ...
        rows: [
          ...
          ['NTFS', 'New Technology File System', 'Windows defaultsupports permissions, encryption, journaling'],
          ['GPT', 'GUID Partition Table', 'Modern partition schemesupports 128 partitions, 18 EB max disk'],
          ['MBR', 'Master Boot Record', 'Legacy partition scheme4 primary partitions, 2 TB max disk'],
      ...
      { type: 'heading', text: '6. Troubleshooting Tools & Utilities' },
      {
        ...
        rows: [
          ...
          ['BSOD', 'Blue Screen of Death', 'Windows critical stop errorrequires driver/hardware diagnosis'],
          ['WinRE', 'Windows Recovery Environment', 'Boot time repair console for non bootable systems'],
          ['PXE', 'Preboot Execution Environment', 'Network bootpulls OS image from server via TFTP/HTTP'],
    ...
    content: [
      ...
      { type: 'heading', text: '1. Global Search (Ctrl + K)' },
      {
        ...
        items: [
          ...
          'Start typing a keywordresults appear in real time as you type. Matches are pulled from article titles, tags, and content.',
      ...
      { type: 'heading', text: '2. The SidebarDomain Dashboard Structure' },
      {
        type: 'paragraph',
      ...
      },
      {
        ...
        rows: [
          ['CompTIA A+ Core 1 (220-1201)', 'Domains 1.0\u20135.0: Mobile, Networking, Hardware, Cloud, Troubleshooting', 'Primary study trackstart here for exam prep'],
          ['CompTIA A+ Core 2 (220-1202)', 'Domains 1.0\u20134.0: OS, Security, Software Troubleshooting, SOPs', 'Second exam tracktackle after Core 1 foundations'],
      ...
      {
        type: 'tip',
        text: 'Each domain page has its own "Add Intel" button. If you submit a resource from within a domain page, the system automatically tags it to that domainno manual categorization needed.',
      },
      ...
      {
        type: 'paragraph',
        text: 'Domain pages that map to CompTIA exam objectives also display an "Objectives" pill bar at the top. Click any specific objective (e.g., "3.1Troubleshoot common issues with motherboards") to filter the grid to only resources tagged for that exam objective.',
      },
      {
        type: 'warning',
        text: 'If you navigate to a domain and see only [OPEN SLOT] placeholders, it means no peers have submitted content for that area yet. Be the firsthit "Add Intel" and pioneer that module!',
      },
    ],
  },
    ...
    content: [
      ...
      { type: 'heading', text: '1. Opening the Submission Modal' },
      {
        ...
        items: [
          ...
          'The submission form opens as a modal overlayyou do not leave your current page.',
          'Choose your Submission Type first (Article, Diagram, Study Tip, or Resource Link). The form adapts to your selection.',
        ],
      },
      ...
      },
      {
        type: 'steps',
        items: [
          'Begin typing your nameafter 1 or more characters, a dropdown appears showing matching names already in the system.',
          ...
          'The autocomplete is case insensitivetyping "jam" will match "Jamin Ware" just as well as "Jam".',
        ],
      },
      {
        type: 'tip',
      ...
      { type: 'heading', text: '3. Filling Out the Form' },
      {
        ...
        rows: [
          ...
          ['Content / URL', 'Yes', 'The actual resourcemarkdown text, a diagram, or a link'],
      ...
      {
        type: 'warning',
        text: 'Submissions that contain incorrect technical information, plagiarized content, or inappropriate material will be rejected during moderation. Always verify your facts before submittingcite sources where possible.',
      },
    ],
  },
