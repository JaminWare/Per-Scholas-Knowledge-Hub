    ...
    <div className={`${CARD_WIDTH} group flex flex-col rounded-xl border overflow-hidden bg-zinc-100/60 dark:bg-zinc-900 border-sky-200/60 dark:border-zinc-800`}>
      ...
      <div className="flex flex-col gap-3 p-4 flex-1">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-semibold text-sm leading-snug text-sky-800 dark:text-white transition-colors duration-200 dark:group-hover:text-sky-400">
              {domain} — {context}
            </h3>
            <div className="flex items-center gap-1.5 mt-1">
              ...
              <span className="text-[11px] text-sky-500 dark:text-white truncate font-mono font-bold tracking-wider transition-colors duration-200 dark:group-hover:text-sky-400" style={{ textShadow: '0 0 6px rgba(56,189,248,0.6)' }}>[OPEN SLOT]</span>
            </div>
          </div>
        </div>
        <p className="text-[11px] text-sky-600 dark:text-white transition-colors duration-200 dark:group-hover:text-sky-400 bg-sky-100/60 dark:bg-sky-500/10 rounded-lg px-2.5 py-2 border border-sky-200/60 dark:border-sky-500/20" style={{ textShadow: '0 0 6px rgba(56,189,248,0.4)' }}>
          This curriculum endpoint is currently open for peer review and documentation.
        </p>
        <button
          type="button"
